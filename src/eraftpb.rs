...
impl HardState {
    ...
    // uint64 began_conf_change_at = 4;

    pub fn clear_began_conf_change_at(&mut self) {
        self.began_conf_change_at = 0;
    }

    // Param is passed by value, moved
    pub fn set_began_conf_change_at(&mut self, v: u64) {
        self.began_conf_change_at = v;
    }

    pub fn get_began_conf_change_at(&self) -> u64 {
        self.began_conf_change_at
    }
}
...
impl ::protobuf::Message for HardState {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.began_conf_change_at != 0 {
            my_size += ::protobuf::rt::value_size(4, self.began_conf_change_at, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.began_conf_change_at != 0 {
            os.write_uint64(4, self.began_conf_change_at)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "began_conf_change_at",
                    |m: &HardState| { &m.began_conf_change_at },
                    |m: &mut HardState| { &mut m.began_conf_change_at },
                ));
...
impl ::protobuf::Clear for HardState {
    fn clear(&mut self) {
        ...
        self.clear_vote();
        self.clear_commit();
        self.clear_began_conf_change_at();
        self.unknown_fields.clear();
    }
}
...
impl ::protobuf::ProtobufEnum for ConfChangeType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ConfChangeType> {
        match value {
            ...
            3 => ::std::option::Option::Some(ConfChangeType::BeginConfChange),
            4 => ::std::option::Option::Some(ConfChangeType::FinalizeConfChange),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    mmit\x18\x03\x20\x01(\x04R\x06commit\x12/\n\x14began_conf_change_at\x18\
    \x04\x20\x01(\x04R\x11beganConfChangeAt\"=\n\tConfState\x12\x14\n\x05nod\
    es\x18\x01\x20\x03(\x04R\x05nodes\x12\x1a\n\x08learners\x18\x02\x20\x03(\
    \x04R\x08learners\"\xe4\x01\n\nConfChange\x12\x0e\n\x02id\x18\x01\x20\
    ...
    \x17\n\xe7\x04\n\x02\x04\0\x12\x04\x12\0\x1c\x01\x1a\xda\x04\x20The\x20e\
    ...
    l\x20entries,\x20the\x20data\x20field\x20should\x20contain\x20the\x20dat\
    a\x20change\x20that\x20should\x20be\x20applied.\r\n\x20The\x20context\
    \x20field\x20can\x20be\x20used\x20for\x20any\x20contextual\x20data\x20th\
    at\x20might\x20be\x20relevant\x20to\x20the\r\n\x20application\x20of\x20t\
    he\x20data.\r\n\r\n\x20For\x20configuration\x20changes,\x20the\x20data\
    \x20will\x20contain\x20the\x20ConfChange\x20message\x20and\x20the\r\n\
    \x20context\x20will\x20provide\x20anything\x20needed\x20to\x20assist\x20\
    the\x20configuration\x20change.\x20The\x20context\r\n\x20if\x20for\x20th\
    e\x20user\x20to\x20set\x20and\x20use\x20in\x20this\x20case.\r\n\n\n\n\
    ...
    \x16\x1ab\x20Deprecated!\x20It\x20is\x20kept\x20for\x20backward\x20compa\
    tibility.\r\n\x20TODO:\x20remove\x20it\x20in\x20the\x20next\x20major\x20\
    ...
    \x04\x04\x02\x03\x12\x03T\x04$\x1a\x8c\x01\x20HACK:\x20Our\x20current\
    \x20Protobuf\x20uses\x20`0`\x20as\x20`None`.\r\n\x20Good\x20thing\x20we\
    \x20know\x20that\x20index\x200\x20of\x20the\x20raft\x20log\x20is\x20alwa\
    ys\x20not\x20important\x20in\x20this\x20context.\r\n\n\r\n\x05\x04\x04\
    \x02\x03\x04\x12\x04T\x04Q\x16\n\x0c\n\x05\x04\x04\x02\x03\x05\x12\x03T\
    \x04\n\n\x0c\n\x05\x04\x04\x02\x03\x01\x12\x03T\x0b\x1f\n\x0c\n\x05\x04\
    \x04\x02\x03\x03\x12\x03T\"#\n\n\n\x02\x04\x05\x12\x04W\0Z\x01\n\n\n\x03\
    \x04\x05\x01\x12\x03W\x08\x11\n\x0b\n\x04\x04\x05\x02\0\x12\x03X\x04\x1e\
    \n\x0c\n\x05\x04\x05\x02\0\x04\x12\x03X\x04\x0c\n\x0c\n\x05\x04\x05\x02\
    \0\x05\x12\x03X\r\x13\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x03X\x14\x19\n\
    \x0c\n\x05\x04\x05\x02\0\x03\x12\x03X\x1c\x1d\n\x0b\n\x04\x04\x05\x02\
    \x01\x12\x03Y\x04!\n\x0c\n\x05\x04\x05\x02\x01\x04\x12\x03Y\x04\x0c\n\
    \x0c\n\x05\x04\x05\x02\x01\x05\x12\x03Y\r\x13\n\x0c\n\x05\x04\x05\x02\
    \x01\x01\x12\x03Y\x14\x1c\n\x0c\n\x05\x04\x05\x02\x01\x03\x12\x03Y\x1f\
    \x20\n\n\n\x02\x05\x02\x12\x04\\\0b\x01\n\n\n\x03\x05\x02\x01\x12\x03\\\
    \x05\x13\n\x0b\n\x04\x05\x02\x02\0\x12\x03]\x04\x13\n\x0c\n\x05\x05\x02\
    \x02\0\x01\x12\x03]\x04\x0b\n\x0c\n\x05\x05\x02\x02\0\x02\x12\x03]\x11\
    ...
    \x06\x02\x02\x12\x03h\x04\x17\x1a9\x20Used\x20in\x20`AddNode`,\x20`Remov\
    ...
    \x03k\x04\x20\x1a6\x20Used\x20in\x20`BeginConfChange`\x20and\x20`Finaliz\
    eConfChange`.\r\n\n\r\n\x05\x04\x06\x02\x04\x04\x12\x04k\x04i\x16\n\x0c\
    \n\x05\x04\x06\x02\x04\x06\x12\x03k\x04\r\n\x0c\n\x05\x04\x06\x02\x04\
    \x01\x12\x03k\x0e\x1b\n\x0c\n\x05\x04\x06\x02\x04\x03\x12\x03k\x1e\x1f\n\
    \xc7\x01\n\x04\x04\x06\x02\x05\x12\x03o\x04\x1b\x1a\xb9\x01\x20Used\x20i\
    n\x20`BeginConfChange`\x20and\x20`FinalizeConfChange`.\r\n\x20Because\
    \x20`RawNode::apply_conf_change`\x20takes\x20a\x20`ConfChange`\x20instea\
    d\x20of\x20an\x20`Entry`\x20we\x20must\r\n\x20include\x20this\x20index\
    \x20so\x20it\x20can\x20be\x20known.\r\n\n\r\n\x05\x04\x06\x02\x05\x04\
    \x12\x04o\x04k\x20\n\x0c\n\x05\x04\x06\x02\x05\x05\x12\x03o\x04\n\n\x0c\
    \n\x05\x04\x06\x02\x05\x01\x12\x03o\x0b\x16\n\x0c\n\x05\x04\x06\x02\x05\
    \x03\x12\x03o\x19\x1ab\x06proto3\
";
