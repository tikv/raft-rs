...
pub struct SnapshotMetadata {
    ...
    pub pending_membership_change: ::protobuf::SingularPtrField<ConfChange>,
    pub index: u64,
    pub term: u64,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
...
impl SnapshotMetadata {
    ...
    // .eraftpb.ConfChange pending_membership_change = 4;
    ...
    // Param is passed by value, moved
    pub fn set_pending_membership_change(&mut self, v: ConfChange) {
        self.pending_membership_change = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_pending_membership_change(&mut self) -> &mut ConfChange {
    ...
    // Take field
    pub fn take_pending_membership_change(&mut self) -> ConfChange {
        self.pending_membership_change.take().unwrap_or_else(|| ConfChange::new())
    }

    pub fn get_pending_membership_change(&self) -> &ConfChange {
        self.pending_membership_change.as_ref().unwrap_or_else(|| ConfChange::default_instance())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<ConfChange>>(
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<ConfChange>>(
                    "pending_membership_change",
                    |m: &HardState| { &m.pending_membership_change },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x05\x20\x01(\x08R\x07syncLog\"\xc0\x01\n\x10SnapshotMetadata\x121\n\
    \nconf_state\x18\x01\x20\x01(\x0b2\x12.eraftpb.ConfStateR\tconfState\x12\
    O\n\x19pending_membership_change\x18\x04\x20\x01(\x0b2\x13.eraftpb.ConfC\
    hangeR\x17pendingMembershipChange\x12\x14\n\x05index\x18\x02\x20\x01(\
    \x04R\x05index\x12\x12\n\x04term\x18\x03\x20\x01(\x04R\x04term\"U\n\x08S\
    napshot\x12\x12\n\x04data\x18\x01\x20\x01(\x0cR\x04data\x125\n\x08metada\
    ta\x18\x02\x20\x01(\x0b2\x19.eraftpb.SnapshotMetadataR\x08metadata\"\xe7\
    \x02\n\x07Message\x12/\n\x08msg_type\x18\x01\x20\x01(\x0e2\x14.eraftpb.M\
    essageTypeR\x07msgType\x12\x0e\n\x02to\x18\x02\x20\x01(\x04R\x02to\x12\
    \x12\n\x04from\x18\x03\x20\x01(\x04R\x04from\x12\x12\n\x04term\x18\x04\
    \x20\x01(\x04R\x04term\x12\x19\n\x08log_term\x18\x05\x20\x01(\x04R\x07lo\
    gTerm\x12\x14\n\x05index\x18\x06\x20\x01(\x04R\x05index\x12(\n\x07entrie\
    s\x18\x07\x20\x03(\x0b2\x0e.eraftpb.EntryR\x07entries\x12\x16\n\x06commi\
    t\x18\x08\x20\x01(\x04R\x06commit\x12-\n\x08snapshot\x18\t\x20\x01(\x0b2\
    \x11.eraftpb.SnapshotR\x08snapshot\x12\x16\n\x06reject\x18\n\x20\x01(\
    \x08R\x06reject\x12\x1f\n\x0breject_hint\x18\x0b\x20\x01(\x04R\nrejectHi\
    nt\x12\x18\n\x07context\x18\x0c\x20\x01(\x0cR\x07context\"\x9c\x01\n\tHa\
    rdState\x12\x12\n\x04term\x18\x01\x20\x01(\x04R\x04term\x12\x12\n\x04vot\
    e\x18\x02\x20\x01(\x04R\x04vote\x12\x16\n\x06commit\x18\x03\x20\x01(\x04\
    R\x06commit\x12O\n\x19pending_membership_change\x18\x04\x20\x01(\x0b2\
    \x13.eraftpb.ConfChangeR\x17pendingMembershipChange\"=\n\tConfState\x12\
    \x14\n\x05nodes\x18\x01\x20\x03(\x04R\x05nodes\x12\x1a\n\x08learners\x18\
    \x02\x20\x03(\x04R\x08learners\"\xe4\x01\n\nConfChange\x12\x0e\n\x02id\
    \x18\x01\x20\x01(\x04R\x02id\x128\n\x0bchange_type\x18\x02\x20\x01(\x0e2\
    \x17.eraftpb.ConfChangeTypeR\nchangeType\x12\x17\n\x07node_id\x18\x03\
    \x20\x01(\x04R\x06nodeId\x12\x18\n\x07context\x18\x04\x20\x01(\x0cR\x07c\
    ontext\x128\n\rconfiguration\x18\x05\x20\x01(\x0b2\x12.eraftpb.ConfState\
    R\rconfiguration\x12\x1f\n\x0bstart_index\x18\x06\x20\x01(\x04R\nstartIn\
    ...
    \x01\x02\x02\x01\x12\x03!\x0b\x10\n\x0c\n\x05\x04\x01\x02\x02\x03\x12
n\x0c\n\x05\x04\x05\x02\x01\x05\x12\x03Y\r\x13\n\x0c\n\x05\x04\
    \x05\x02\x01\x01\x12\x03Y\x14\x1c\n\x0c\n\x05\x04\x05\x02\x01\x03\x12\
    ...
    \x02\x12\x03_\x15\x16\n\x0b\n\x04\x05\x02\x02\x03\x12\x03`\x04\x1e\n\x0c\
    \n\x05\x05\x02\x02\x03\x01\x12\x03`\x04\x19\n\x0c\n\x05\x05\x02\x02\x03\
    \x02\x12\x03`\x1c\x1d\n\x0b\n\x04\x05\x02\x02\x04\x12\x03a\x04!\n\x0c\n\
    \x05\x05\x02\x02\x04\x01\x12\x03a\x04\x1c\n\x0c\n\x05\x05\x02\x02\x04\
    \x02\x12\x03a\x1f\x20\n\n\n\x02\x04\x06\x12\x04d\0p\x01\n\n\n\x03\x04\
    \x06\x01\x12\x03d\x08\x12\n\x0b\n\x04\x04\x06\x02\0\x12\x03e\x04\x12\n\r\
    \n\x05\x04\x06\x02\0\x04\x12\x04e\x04d\x14\n\x0c\n\x05\x04\x06\x02\0\x05\
    \x12\x03e\x04\n\n\x0c\n\x05\x04\x06\x02\0\x01\x12\x03e\x0b\r\n\x0c\n\x05\
    \x04\x06\x02\0\x03\x12\x03e\x10\x11\n\x0b\n\x04\x04\x06\x02\x01\x12\x03f\
    \x04#\n\r\n\x05\x04\x06\x02\x01\x04\x12\x04f\x04e\x12\n\x0c\n\x05\x04\
    \x06\x02\x01\x06\x12\x03f\x04\x12\n\x0c\n\x05\x04\x06\x02\x01\x01\x12\
    \x03f\x13\x1e\n\x0c\n\x05\x04\x06\x02\x01\x03\x12\x03f!\"\nE\n\x04\x04\
    \x06\x02\x02\x12\x03h\x04\x17\x1a8\x20Used\x20in\x20`AddNode`,\x20`Remov\
    eNode`,\x20and\x20`AddLearnerNode`.\n\n\r\n\x05\x04\x06\x02\x02\x04\x12\
    \x04h\x04f#\n\x0c\n\x05\x04\x06\x02\x02\x05\x12\x03h\x04\n\n\x0c\n\x05\
    \x04\x06\x02\x02\x01\x12\x03h\x0b\x12\n\x0c\n\x05\x04\x06\x02\x02\x03\
    \x12\x03h\x15\x16\n\x0b\n\x04\x04\x06\x02\x03\x12\x03i\x04\x16\n\r\n\x05\
    \x04\x06\x02\x03\x04\x12\x04i\x04h\x17\n\x0c\n\x05\x04\x06\x02\x03\x05\
    \x12\x03i\x04\t\n\x0c\n\x05\x04\x06\x02\x03\x01\x12\x03i\n\x11\n\x0c\n\
    \x05\x04\x06\x02\x03\x03\x12\x03i\x14\x15\nN\n\x04\x04\x06\x02\x04\x12\
    \x03k\x04\x20\x1aA\x20Used\x20in\x20`BeginMembershipChange`\x20and\x20`F\
    inalizeMembershipChange`.\n\n\r\n\x05\x04\x06\x02\x04\x04\x12\x04k\x04i\
    \x16\n\x0c\n\x05\x04\x06\x02\x04\x06\x12\x03k\x04\r\n\x0c\n\x05\x04\x06\
    \x02\x04\x01\x12\x03k\x0e\x1b\n\x0c\n\x05\x04\x06\x02\x04\x03\x12\x03k\
    \x1e\x1f\n\xd0\x01\n\x04\x04\x06\x02\x05\x12\x03o\x04\x1b\x1a\xc2\x01\
    \x20Used\x20in\x20`BeginMembershipChange`\x20and\x20`FinalizeMembershipC\
    hange`.\n\x20Because\x20`RawNode::apply_conf_change`\x20takes\x20a\x20`C\
    onfChange`\x20instead\x20of\x20an\x20`Entry`\x20we\x20must\n\x20include\
    \x20this\x20index\x20so\x20it\x20can\x20be\x20known.\n\n\r\n\x05\x04\x06\
    \x02\x05\x04\x12\x04o\x04k\x20\n\x0c\n\x05\x04\x06\x02\x05\x05\x12\x03o\
    \x04\n\n\x0c\n\x05\x04\x06\x02\x05\x01\x12\x03o\x0b\x16\n\x0c\n\x05\x04\
    \x06\x02\x05\x03\x12\x03o\x19\x1ab\x06proto3\
";
