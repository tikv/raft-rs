...
impl SnapshotMetadata {
    ...
    // uint64 next_conf_state_index = 6;
...
impl ::protobuf::Message for SnapshotMetadata {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.conf_state_index != 0 {
            my_size += ::protobuf::rt::value_size(5, self.conf_state_index, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.next_conf_state_index != 0 {
            my_size += ::protobuf::rt::value_size(6, self.next_conf_state_index, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.index != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.conf_state_index != 0 {
            os.write_uint64(5, self.conf_state_index)?;
        }
        if let Some(ref v) = self.next_conf_state.as_ref() {
        ...
        if self.next_conf_state_index != 0 {
            os.write_uint64(6, self.next_conf_state_index)?;
        }
        if self.index != 0 {
...
impl ::protobuf::Clear for SnapshotMetadata {
    fn clear(&mut self) {
        ...
        self.clear_conf_state_index();
        self.clear_next_conf_state();
        self.clear_next_conf_state_index();
        self.clear_index();
        self.clear_term();
        self.unknown_fields.clear();
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x05\x20\x01(\x08R\x07syncLog\"\x88\x02\n\x10SnapshotMetadata\x121\n\
    \nconf_state\x18\x01\x20\x01(\x0b2\x12.eraftpb.ConfStateR\tconfState\x12\
    (\n\x10conf_state_index\x18\x05\x20\x01(\x04R\x0econfStateIndex\x12:\n\
    \x0fnext_conf_state\x18\x04\x20\x01(\x0b2\x12.eraftpb.ConfStateR\rnextCo\
    nfState\x121\n\x15next_conf_state_index\x18\x06\x20\x01(\x04R\x12nextCon\
    fStateIndex\x12\x14\n\x05index\x18\x02\x20\x01(\x04R\x05index\x12\x12\n\
    \x04term\x18\x03\x20\x01(\x04R\x04term\"U\n\x08Snapshot\x12\x12\n\x04dat\
    a\x18\x01\x20\x01(\x0cR\x04data\x125\n\x08metadata\x18\x02\x20\x01(\x0b2\
    \x19.eraftpb.SnapshotMetadataR\x08metadata\"\xe7\x02\n\x07Message\x12/\n\
    \x08msg_type\x18\x01\x20\x01(\x0e2\x14.eraftpb.MessageTypeR\x07msgType\
    \x12\x0e\n\x02to\x18\x02\x20\x01(\x04R\x02to\x12\x12\n\x04from\x18\x03\
    \x20\x01(\x04R\x04from\x12\x12\n\x04term\x18\x04\x20\x01(\x04R\x04term\
    \x12\x19\n\x08log_term\x18\x05\x20\x01(\x04R\x07logTerm\x12\x14\n\x05ind\
    ex\x18\x06\x20\x01(\x04R\x05index\x12(\n\x07entries\x18\x07\x20\x03(\x0b\
    2\x0e.eraftpb.EntryR\x07entries\x12\x16\n\x06commit\x18\x08\x20\x01(\x04\
    ...
    \x18\x02\x20\x03(\x04R\x08learners\"\xe4\x01\n\nConfChange\x12\x0e\n\x02\
    ...
    \x07context\x128\n\rconfiguration\x18\x05\x20\x01(\x0b2\x12.eraftpb.Conf\
    StateR\rconfiguration\x12\x1f\n\x0bstart_index\x18\x06\x20\x01(\x04R\nst\
    artIndex*1\n\tEntryType\x12\x0f\n\x0bEntryNormal\x10\0\x12\x13\n\x0fEntr\
    yConfChange\x10\x01*\x8c\x03\n\x0bMessageType\x12\n\n\x06MsgHup\x10\0\
    ...
    \x01\x12\x12\n\x0eAddLearnerNode\x10\x02\x12\x19\n\x15BeginMembershipCha\
    nge\x10\x03\x12\x1c\n\x18FinalizeMembershipChange\x10\x04J\xb8'\n\x06\
    ...
    \x18\n'\n\x04\x04\x01\x02\0\x12\x03\x20\x04\x1d\x1a\x1a\x20The\x20curren\
    t\x20`ConfState`.\n\n\r\n\x05\x04\x01\x02\0\x04\x12\x04\x20\x04\x1e\x1a\
    \n\x0c\n\x05\x04\x01\x02\0\x06\x12\x03\x20\x04\r\n\x0c\n\x05\x04\x01\x02\
    \0\x01\x12\x03\x20\x0e\x18\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\x20\x1b\
    \x1c\n4\n\x04\x04\x01\x02\x01\x12\x03\"\x04\x20\x1a'\x20The\x20index\x20\
    of\x20the\x20current\x20`ConfState`.\n\n\r\n\x05\x04\x01\x02\x01\x04\x12\
    \x04\"\x04\x20\x1d\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03\"\x04\n\n\x0c\
    \n\x05\x04\x01\x02\x01\x01\x12\x03\"\x0b\x1b\n\x0c\n\x05\x04\x01\x02\x01\
    \x03\x12\x03\"\x1e\x1f\n@\n\x04\x04\x01\x02\x02\x12\x03%\x04\"\x1a3\x20T\
    he\x20next\x20`ConfState`,\x20only\x20for\x20membership\x20change.\n\n\r\
    \n\x05\x04\x01\x02\x02\x04\x12\x04%\x04\"\x20\n\x0c\n\x05\x04\x01\x02\
    \x02\x06\x12\x03%\x04\r\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x03%\x0e\x1d\
    \n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x03%\x20!\n1\n\x04\x04\x01\x02\x03\
    \x12\x03'\x04%\x1a$\x20The\x20index\x20of\x20the\x20next\x20`ConfState`.\
    \n\n\r\n\x05\x04\x01\x02\x03\x04\x12\x04'\x04%\"\n\x0c\n\x05\x04\x01\x02\
    \x03\x05\x12\x03'\x04\n\n\x0c\n\x05\x04\x01\x02\x03\x01\x12\x03'\x0b\x20\
    \n\x0c\n\x05\x04\x01\x02\x03\x03\x12\x03'#$\n!\n\x04\x04\x01\x02\x04\x12\
    \x03*\x04\x15\x1a\x14\x20The\x20applied\x20index.\n\n\r\n\x05\x04\x01\
    \x02\x04\x04\x12\x04*\x04'%\n\x0c\n\x05\x04\x01\x02\x04\x05\x12\x03*\x04\
    \n\n\x0c\n\x05\x04\x01\x02\x04\x01\x12\x03*\x0b\x10\n\x0c\n\x05\x04\x01\
    \x02\x04\x03\x12\x03*\x13\x14\n-\n\x04\x04\x01\x02\x05\x12\x03,\x04\x14\
    \x1a\x20\x20The\x20term\x20of\x20the\x20applied\x20index.\n\n\r\n\x05\
    \x04\x01\x02\x05\x04\x12\x04,\x04*\x15\n\x0c\n\x05\x04\x01\x02\x05\x05\
    ...
    \x03\x02\t\x05\x12\x03T\x04\x08\n\x0c\n\x05\x04\x03\x02\t\x01\x12\x03T\t\
    \x0f\n\x0c\n\x05\x04\x03\x02\t\x03\x12\x03T\x12\x14\n\x0b\n\x04\x04\x03\
    \x02\n\x12\x03U\x04\x1c\n\r\n\x05\x04\x03\x02\n\x04\x12\x04U\x04T\x15\n\
    \x0c\n\x05\x04\x03\x02\n\x05\x12\x03U\x04\n\n\x0c\n\x05\x04\x03\x02\n\
    \x01\x12\x03U\x0b\x16\n\x0c\n\x05\x04\x03\x02\n\x03\x12\x03U\x19\x1b\n\
    \x05\x02\x02\x04\x01\x12\x03i\x04\x1c\n\x0c\n\x05\x05\x02\x02\x04\x02\
    \x12\x03i\x1f\x20\n\n\n\x02\x04\x06\x12\x04l\0z\x01\n\n\n\x03\x04\x06\
    \x01\x12\x03l\x08\x12\n\x0b\n\x04\x04\x06\x02\0\x12\x03m\x04\x12\n\r\n\
    \x05\x04\x06\x02\0\x04\x12\x04m\x04l\x14\n\x0c\n\x05\x04\x06\x02\0\x05\
    \x12\x03m\x04\n\n\x0c\n\x05\x04\x06\x02\0\x01\x12\x03m\x0b\r\n\x0c\n\x05\
    \x04\x06\x02\0\x03\x12\x03m\x10\x11\n\x0b\n\x04\x04\x06\x02\x01\x12\x03n\
    \x04#\n\r\n\x05\x04\x06\x02\x01\x04\x12\x04n\x04m\x12\n\x0c\n\x05\x04\
    \x06\x02\x01\x06\x12\x03n\x04\x12\n\x0c\n\x05\x04\x06\x02\x01\x01\x12\
    \x03n\x13\x1e\n\x0c\n\x05\x04\x06\x02\x01\x03\x12\x03n!\"\nE\n\x04\x04\
    \x06\x02\x02\x12\x03p\x04\x17\x1a8\x20Used\x20in\x20`AddNode`,\x20`Remov\
    eNode`,\x20and\x20`AddLearnerNode`.\n\n\r\n\x05\x04\x06\x02\x02\x04\x12\
    \x04p\x04n#\n\x0c\n\x05\x04\x06\x02\x02\x05\x12\x03p\x04\n\n\x0c\n\x05\
    \x04\x06\x02\x02\x01\x12\x03p\x0b\x12\n\x0c\n\x05\x04\x06\x02\x02\x03\
    \x12\x03p\x15\x16\nC\n\x04\x04\x06\x02\x03\x12\x03s\x04\x16\x1a6\x20Some\
    \x20extra\x20information\x20used\x20in\x20configuration\x20change.\n\n\r\
    \n\x05\x04\x06\x02\x03\x04\x12\x04s\x04p\x17\n\x0c\n\x05\x04\x06\x02\x03\
    \x05\x12\x03s\x04\t\n\x0c\n\x05\x04\x06\x02\x03\x01\x12\x03s\n\x11\n\x0c\
    \n\x05\x04\x06\x02\x03\x03\x12\x03s\x14\x15\nN\n\x04\x04\x06\x02\x04\x12\
    \x03v\x04\x20\x1aA\x20Used\x20in\x20`BeginMembershipChange`\x20and\x20`F\
    inalizeMembershipChange`.\n\n\r\n\x05\x04\x06\x02\x04\x04\x12\x04v\x04s\
    \x16\n\x0c\n\x05\x04\x06\x02\x04\x06\x12\x03v\x04\r\n\x0c\n\x05\x04\x06\
    \x02\x04\x01\x12\x03v\x0e\x1b\n\x0c\n\x05\x04\x06\x02\x04\x03\x12\x03v\
    \x1e\x1f\n/\n\x04\x04\x06\x02\x05\x12\x03y\x04\x1b\x1a\"\x20Used\x20in\
    \x20`BeginMembershipChange`.\n\n\r\n\x05\x04\x06\x02\x05\x04\x12\x04y\
    \x04v\x20\n\x0c\n\x05\x04\x06\x02\x05\x05\x12\x03y\x04\n\n\x0c\n\x05\x04\
    \x06\x02\x05\x01\x12\x03y\x0b\x16\n\x0c\n\x05\x04\x06\x02\x05\x03\x12\
    \x03y\x19\x1ab\x06proto3\
";
